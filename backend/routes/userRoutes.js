...
router.put("/:id/follow-request/accept", verifyToken, acceptFollowRequest);
router.put("/:id/follow-request/reject", verifyToken, rejectFollowRequest);
router.post("/follow-requests/:id/accept", verifyToken, acceptFollowRequest);
router.post("/follow-requests/:id/reject", verifyToken, rejectFollowRequest);
router.put("/follow-requests/:id/accept", verifyToken, acceptFollowRequest);
router.put("/follow-requests/:id/reject", verifyToken, rejectFollowRequest);
