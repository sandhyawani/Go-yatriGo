        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-slate-100">
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-full bg-background text-text-muted hover hover:text-text-primary transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative aspect-[16/9] rounded-xl overflow-hidden bg-background border border-slate-200">
                  {currentCover ? (
                    <img
                      src={currentCover}
                      alt="Current Cover"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative aspect-[16/9] rounded-xl overflow-hidden bg-primary-50/50 border border-primary-200 flex items-center justify-center">
                  {previewUrl ? (
                    <img
                      src={previewUrl}
            ...
            <div
              ...
              className={`relative cursor-pointer rounded-2xl border-2 border-dashed p-4 sm:p-5 text-center transition-all ${
                isDragging
                  ...
                  : "border-slate-200 hover:border-primary-300 hover"
              }`}
            >
              <input
                ref={fileInputRef}
            ...
            <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-slate-100">
              <button
                ...
                onClick={handleClose}
                disabled={isUploading}
                className="px-4 py-2 text-xs font-bold text-text-secondary hover:bg-background rounded-xl transition-colors"
              >
                Cancel
              </button>
