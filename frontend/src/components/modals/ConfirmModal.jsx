        ...
        >
          ...
          <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 sm:py-4 border-b border-slate-100">
            ...
            <button
              onClick={onClose}
              disabled={isLoading}
              className="p-1.5 sm:p-2 rounded-full hover:bg-background transition-colors text-text-muted hover:text-text-secondary disabled:opacity-50"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="px-4 sm:px-6 py-3.5 sm:py-4 bg-slate-50 flex flex-col sm:flex-row justify-end gap-2.5 sm:gap-3 rounded-b-3xl">
            <button
              onClick={onClose}
              disabled={isLoading}
              className="w-full sm:w-auto px-4 sm:px-5 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-text-secondary bg-white border border-slate-200 hover transition-colors shadow-sm disabled:opacity-50 order-2 sm:order-1"
            >
              {cancelText}
            </button>
            <button
              ...
              className={`w-full sm:w-auto px-4 sm:px-5 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white shadow-sm transition-colors flex items-center justify-center gap-2 order-1 sm:order-2 ${
                isDanger ? "bg-rose-500 hover:bg-rose-600" : "bg-brand hover:bg-brand-dark"
              } disabled:opacity-50`}
            >
              {isLoading ? (
                <>
