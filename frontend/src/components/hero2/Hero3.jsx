        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="mt-6 text-slate-400 text-lg leading-relaxed">
              Connect with fellow travelers, form groups, and share amazing moments across Indian destinations without jumping between separate systems. From heritage routes to city breaks, Go riGo keeps the essentials in one place.
            </p>
