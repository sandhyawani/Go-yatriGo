...
import { X, Search, MoreHorizontal, Eye, UserMinus, AlertTriangle, RefreshCw, Users } from "lucide-react";
...
const FollowersModal = ({
  ...
  const handleAdd = (user) => {
    if (handleAddTripMate) {
      handleAddTripMate(user._id);
    } else {
      showToast.success(`${user.name} added as Trip Mate`);
    }
  };
    ...
    <>
      ...
      <ConfirmModal
        ...
        message={`Are you sure you want to remove ${
          confirmState.user?.name || "this user"
