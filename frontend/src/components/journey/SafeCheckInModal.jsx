      ...
      <div className="relative w-full sm:max-w-md bg-white dark:bg-slate-900 sm:rounded-3xl rounded-t-3xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden max-h-[92dvh] sm:max-h-[90vh] flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                Auto-syncs status with squad & trusted emergency contacts
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
          ...
          <div className="flex gap-3 pt-2">
            ...
            type="submit"
            disabled={loading}
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-[#7C3AED] hover:bg-[#7c3aed] text-white text-sm font-bold shadow-lg shadow-[#7C3AED]/30 transition-all active:scale-95 disabled:opacity-50">
