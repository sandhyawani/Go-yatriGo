            ...
            >
              <div className="p-5 space-y-4 overflow-y-auto flex-1 no-scrollbar">
                ...
                {!selectedFile ? (
                  ...
                  <div className="p-3.5 bg-purple-50/40 dark:bg-slate-800/60 rounded-2xl border border-purple-200/60 dark:border-slate-700 flex items-center justify-between gap-3 shadow-xs">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-14 h-14 rounded-xl overflow-hidden bg-slate-200 dark:bg-slate-900 shrink-0 border border-slate-300/80 dark:border-slate-700 relative flex items-center justify-center">
                        {detectedType === "video" ? (
                          <>
                            <video
                              src={previewUrl}
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] font-semibold text-[#6C4DF6] mt-0.5">
                          {formatFileSize(selectedFile.size)} •{" "}
                          {detectedType === "video" ? "Video Clip" : "Photo"}
                        </p>
                      </div>
                    </div>
                    ...
                    {!loading && !uploadSuccess && (
                      <div className="flex items-center gap-1.5 shrink-0">
                        <button
                          ...
                          className="p-1.5 rounded-xl bg-red-50 dark:bg-red-950/40 hover:bg-red-100 text-red-600 transition-all shrink-0"
                          title="Remove file"
                        >
