...
//             {/* Left: Branding & Image Update */}
//             <div className="lg:w-1/3 bg-slate-950 p-8 text-white flex flex-col items-center justify-center text-center relative overflow-hidden">
//               <div className="absolute inset-0 bg-gradient-to-br from-brand-600/20 to-purple-600/20 pointer-events-none" />
              
//               <div className="relative z-10 mb-6">
//                 <div className="relative inline-block group">
//                   <div className="w-28 h-28 rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl group-hover:border-brand-500 transition-all duration-300">
//                     <img
//                       className="w-full h-full object-cover"
//                       src={file ? URL.createObjectURL(file) : (state.img || `https://ui-avatars.com/api/?name=${state.name}&background=7c3aed&color=fff`)}
//                       alt={state.name}
//                     />
//                   </div>
//                   <label htmlFor="file" className="absolute -bottom-2 -right-2 p-3 bg-brand-500 text-white rounded-xl shadow-lg cursor-pointer hover:bg-brand-600 transition-all active:scale-90">
...
//                 <h1 className="text-lg font-black tracking-tight mb-2">Refine Identity</h1>
//                 <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-relaxed">
//                   Update your professional profile and system access levels.
//                 </p>
//               </div>
...
//                   <Spinner />
//                   <p className="text-[10px] font-black uppercase tracking-widest mt-4 animate-pulse">Syncing Cloud Assets...</p>
//                 </div>
//               )}
//             </div>
...
//                     <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Full Legal Name</span>
//                     <input
//                       type="text"
//                       value={name}
//                       onChange={(e) => setName(e.target.value)}
//                       className="px-3 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-xs font-bold text-slate-700 outline-none focus:border-brand-500 transition-all"
...
//                 <div>
//                   <label className="flex flex-col gap-1.5">
//                     <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Primary Contact</span>
//                     <input
//                       type="text"
//                       value={mobile}
...
//                 <div>
//                   <label className="flex flex-col gap-1.5">
//                     <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Region / Locale</span>
//                     <input
//                       type="text"
//                       value={country}
...
//                 <div>
//                   <label className="flex flex-col gap-1.5">
//                     <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Access Authorization</span>
//                     <select
//                       value={isAdmin}
//                       onChange={(e) => setisAdmin(e.target.value === "true")}
//                       className="px-3 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-xs font-bold text-slate-700 outline-none focus:border-brand-500 transition-all cursor-pointer"
//                     >
...
//                 <div>
//                   <label className="flex flex-col gap-1.5">
//                     <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Account Classification</span>
//                     <select
//                       value={type}
...
//                 <button
//                   className="w-full bg-slate-900 text-white py-4 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-brand-500 transition-all active:scale-[0.98] shadow-xl shadow-slate-900/10"
//                   type="submit"
//                 >
//                   Commit Changes
//                 </button>
                  ...
                  <div className="w-28 h-28 rounded-2xl overflow-hidden border-4 border-white shadow-xl group-hover:border-purple-200 transition-all duration-300">
                    <img
                      ...
                      src={
                        preview ||
                        state.img ||
                        `https://ui-avatars.com/api/?name=${encodeURIComponent(state.name || "User")}&background=7c3aed&color=fff`
                      }
                      alt={state.name}
                    />
                  </div>
