    ...
    <div className="min-h-screen pt-4 pb-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 flex justify-between items-end">
          ...
          className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl hover transition text-sm font-medium text-text-primary shadow-sm">
        ...
        <div className="flex items-center justify-center py-32">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-text-muted font-medium">Loading requests...</p>
            </div>
          </div> :
        requests.length === 0 ?
        <div className="bg-surface rounded-[var(--radius-card)] border border-slate-200 p-16 text-center shadow-lg shadow-slate-200/50 max-w-2xl mx-auto mt-10">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-brand-50 text-brand mb-6 border-8 border-brand-50/50">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div
          key={user._id}
          className="bg-surface rounded-[var(--radius-card)] border border-slate-200 shadow-lg shadow-slate-200/50 overflow-hidden flex flex-col hover:border-brand/30 hover:shadow-brand-600/10 transition-all group">
              ...
              className="w-14 h-14 rounded-2xl object-cover border border-slate-200 shrink-0 shadow-sm" />
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base font-bold text-text-primary truncate group-hover:text-brand transition-colors">
                      {user.name}
                    </h3>
                ...
                <div className="px-5 pb-5 mt-auto">
                  <div className="flex justify-between items-center mb-4 text-xs font-medium text-text-muted bg-slate-50 p-3 rounded-xl border border-slate-100">
        ...
        className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
          ...
          className={`relative ${isFullscreen ? "w-screen h-screen rounded-none" : "w-[90vw] h-[90vh] rounded-[24px] border border-slate-200"} bg-white shadow-2xl flex flex-col overflow-hidden transition-all duration-300`}>
                ...
                className="w-12 h-12 rounded-full border border-slate-200 object-cover" />
                    ...
                    <div>
                      <h2 className="text-text-primary font-bold text-lg flex items-center gap-3">
                        {selectedUser.name}
                ...
                className="p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-text-secondary hover:bg-brand-50 hover:text-brand-dark hover:border-brand-200 transition group tooltip-trigger">

                      <Download className="w-5 h-5 group-hover:-translate-y-0.5 transition-transform" />
                    </button>
                    <button
                onClick={toggleFullscreen}
                className="p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-text-secondary hover:bg-background hover transition">
                ...
                <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10 flex items-center gap-1 bg-white/90 backdrop-blur-md p-1.5 rounded-2xl border border-slate-200 shadow-lg">
                  ...
                  className="p-2 rounded-xl text-text-secondary hover:bg-background hover:text-text-primary transition">
                  ...
                  className="p-2 rounded-xl text-text-secondary hover:bg-background hover:text-text-primary text-xs font-bold tracking-wider px-3 transition">
                  ...
                  <div className="hidden lg:flex w-full lg:w-96 bg-white flex-col shrink-0 overflow-y-auto">
                    <div className="p-6 space-y-6 flex-1">
                      <h3 className="text-text-muted font-bold text-sm uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">
                        User Details
                      </h3>

                      <div className="space-y-5">
                        <div className="flex items-start gap-4">
                          <div className="p-2.5 rounded-xl bg-slate-50 text-brand border border-slate-100">
                      ...
                      <h3 className="text-text-muted font-bold text-sm uppercase tracking-wider mb-4 border-b border-slate-100 pb-2 pt-6">
                        Verification Info
                      </h3>
              ...
              className="absolute inset-0 z-50 flex items-center justify-center bg-white/60 backdrop-blur-md p-6">
                    ...
                    className="p-2 text-text-muted hover:text-text-primary hover bg-background rounded-xl transition">
                      ...
                      className={`p-4 rounded-xl border text-left transition-all ${rejectReason === reason ? "bg-red-50 border-red-300 text-red-700 font-bold shadow-sm" : "bg-white border-slate-200 text-text-primary hover hover"}`}>
                      ...
                      className="overflow-hidden">
                        ...
                        className="w-full bg-slate-50 border border-slate-300 rounded-xl p-4 text-text-primary placeholder:text-text-muted focus:border-brand focus:ring-1 focus:ring-brand-600 outline-none transition-all shadow-inner"
                        rows={3} />
                        ...
                        <div className="p-6 bg-slate-50 border-t border-slate-200 flex flex-col sm:flex-row justify-end gap-3">
                          <button
                    onClick={() => setIsRejecting(false)}
                    className="px-6 py-3.5 text-text-primary hover:text-text-primary font-bold bg-white border border-slate-300 hover:bg-background rounded-xl transition shadow-sm">
