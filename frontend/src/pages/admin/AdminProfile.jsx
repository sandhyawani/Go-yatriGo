    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-white p-4">
        <div className="text-center">
          ...
          <h2 className="text-base font-semibold text-text-primary">Profile Not Found</h2>
    ...
    <main className="min-h-screen bg-white px-4 pb-10 pt-5 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl space-y-4">
        <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
          <div>
            <h1 className="text-lg font-bold text-text-primary">Administrator Profile</h1>
          ...
          className="inline-flex self-start items-center gap-1.5 rounded-lg bg-white px-3 py-2 text-xs font-semibold text-text-primary shadow-sm ring-1 ring-slate-200 transition-colors hover">
        ...
        className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="relative flex flex-col items-start gap-4 p-5 sm:flex-row sm:items-center sm:p-6">
            <div className="h-16 w-16 shrink-0 rounded-xl bg-gradient-to-tr from-brand-500 to-brand-700 p-[2px] shadow-md sm:h-20 sm:w-20">
            ...
            <div className="min-w-0 flex-1">
              <div className="mb-1.5 flex flex-wrap items-center gap-1.5">
                <span className="inline-flex items-center gap-1 rounded bg-brand-100 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-brand-dark">
              ...
              <h2 className="truncate text-lg font-bold text-text-primary">{user.name}</h2>
          ...
          <div className="space-y-4">
            ...
            className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="space-y-3">
                {[
                {
                  icon: <MapPin className="h-3 w-3 text-text-muted" />,
                  title: "Logged in via Chrome",
                  time: "Today at 10:24 AM"
                },
                {
                  icon: <Edit className="h-3 w-3 text-text-muted" />,
                  title: "Updated system settings",
                  time: "Yesterday at 4:12 PM"
                },
                {
                  icon: <ShieldCheck className="h-3 w-3 text-text-muted" />,
                ...
                <div key={i} className="relative flex items-start gap-2.5">
                    {i < arr.length - 1 &&
                  <div className="absolute bottom-[-12px] left-[11px] top-6 w-px bg-background" />}

                    <div className="z-10 mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-background ring-2 ring-white">
                      {icon}
                    </div>
                    <div>
                      ...
                      <p className="mt-0.5 text-[11px] text-text-muted">{time}</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              <button
              type="button"
              className="mt-4 flex w-full items-center justify-center gap-1 text-[12px] font-medium text-brand transition-colors hover:text-brand-dark">
