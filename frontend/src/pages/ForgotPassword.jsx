...
// import { Mail, ArrowRight, ChevronLeft, AlertCircle, Fingerprint, Sparkles } from "lucide-react";
...
//               <div className="inline-flex items-center justify-center w-12 h-12 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl mb-4 shadow-xl text-brand-400">
//                 <Fingerprint className="w-6 h-6" />
//               </div>
//               <h1 className="text-3xl font-black text-white tracking-tighter">
//                 Forgot Password
//               </h1>
//               <p className="text-white/50 font-medium text-xs mt-2 leading-relaxed">
...
//                     className={`w-full pl-11 pr-4 py-3.5 bg-white/5 border ${
//                       error
//                         ? "border-red-500/50 focus:border-red-400 focus:ring-red-400/20"
//                         : "border-white/10 focus:border-brand-400 focus:ring-brand-400/20"
//                     } rounded-2xl text-white font-bold outline-none focus:bg-white/10 focus:ring-4 transition-all text-sm placeholder:text-white/20 shadow-inner`}
//                   />
//                 </div>
//                 <AnimatePresence>
//                   {error && (
...
//                       className="flex items-center gap-1.5 mt-1 ml-1 text-red-400"
//                     >
...
//               <Link
//                 to="/login"
//                 className="inline-flex items-center gap-2 text-white/30 hover:text-white/80 font-black text-[9px] uppercase tracking-[0.4em] transition-colors group"
//               >
        ...
        <div className="w-full lg:w-2/5 flex flex-col items-center justify-center p-6 sm:p-12 relative overflow-y-auto">
          ...
          >
            ...
            <form className="space-y-4" onSubmit={handleSubmit} noValidate>
              ...
              >
                {loading ? (
                  <span className="text-xs uppercase tracking-widest">Sending…</span>
                ) : (
                  <>
