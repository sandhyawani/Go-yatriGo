              ...
              <div className="relative inline-block mb-4">
                <div className="w-24 h-24 rounded-2xl overflow-hidden border-4 border-slate-50 shadow-md">
                  <img
                    ...
                    src={state.img || `https://ui-avatars.com/api/?name=${state.name}&background=7c3aed&color=fff`}
                    alt={state.name}
                  />
                </div>
              </div>
              <h1 className="text-xl font-black text-slate-900 tracking-tight">{state.name}</h1>
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm h-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                  <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">System Identifier</p>
                  <p className="text-xs font-bold text-slate-700 break-all">{state._id}</p>
                </div>
                <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                  <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">Access Level</p>
                  <p className="text-xs font-bold text-slate-700">{state.isAdmin ? "Administrator" : "Standard Access"}</p>
                </div>
                <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                  <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">Email Communication</p>
                  <p className="text-xs font-bold text-slate-700">{state.email}</p>
                </div>
                <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                  <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">Mobile Contact</p>
                  <p className="text-xs font-bold text-slate-700">{state.mobile || "N/A"}</p>
                </div>
                <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                  <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">Regional Origin</p>
                  <p className="text-xs font-bold text-slate-700">{state.country || "Unspecified"}</p>
                </div>
                <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                  <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">First Interaction</p>
                  <p className="text-xs font-bold text-slate-700 uppercase">{createdatnew}</p>
                </div>
              </div>
            </div>
          </div>
