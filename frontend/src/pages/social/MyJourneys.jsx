...
import { Compass, Plus, Sparkles, Mail, Calendar, Navigation, BookOpen, Layers, ChevronRight, ChevronDown, MapPin, XCircle, Clock, Check, ShieldCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-24 lg:pb-8">
        ...
        <div className="relative overflow-hidden bg-white rounded-3xl p-6 border border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.03)]">
          ...
          <div className="relative z-10 flex items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-brand to-brand-400 text-white flex items-center justify-center shadow-md shadow-brand/20 shrink-0">
              ...
              <div>
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="bg-primary-50 text-brand text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-full border border-primary-200/60 font-sans shadow-xs">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2 font-sans">
                  ...
                  <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-cyan-950 bg-cyan-50/90 px-2.5 py-0.5 rounded-full border border-cyan-200/80 shadow-2xs">
                    <span className="w-1.5 h-1.5 rounded-full bg-cyan-500 animate-pulse" />
                    {activeCount} Active
                  </span>
                  <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-slate-700 bg-slate-50 px-2.5 py-0.5 rounded-full border border-slate-200/80 shadow-2xs">
                    <Check className="w-3 h-3 text-slate-500 stroke-[2.5]" />
                    {completedCount} Completed
                  </span>
                  {cancelledCount > 0 && (
                    <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-rose-700 bg-rose-50/80 px-2.5 py-0.5 rounded-full border border-rose-200/60 shadow-2xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-6 space-y-5">
        ...
        <div className="py-16 text-center">
            <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-brand-50 flex items-center justify-center text-brand">
              <Compass className="w-6 h-6 text-brand animate-spin" />
            </div>
        ...
        <>
          ...
          <div className="py-14 text-center bg-surface rounded-[var(--radius-card)] border border-border-default/60 p-6 max-w-sm mx-auto space-y-3 shadow-soft">
                <div className="w-12 h-12 bg-brand-50 text-brand rounded-xl flex items-center justify-center mx-auto text-xl">
                  📨
                </div>
        ...
        <div className="space-y-8 animate-fade-in bg-white border border-slate-200/80 p-6 rounded-3xl shadow-sm">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <button
            onClick={() => setViewAllCompleted(false)}
            className="inline-flex items-center gap-1.5 text-xs font-black text-brand hover:text-brand transition-colors">
          ...
          <>
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-wider text-cyan-300 bg-cyan-500/15 px-2.5 py-0.5 rounded-full border border-cyan-400/30 flex items-center gap-1.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-cyan-400" /> Journey Underway
                        </span>
                      </div>
                    ...
                    <div className="flex items-center gap-2.5 shrink-0">
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 bg-brand hover:bg-brand-dark text-white font-extrabold text-xs uppercase tracking-wider rounded-xl shadow-md shadow-brand/20 transition-all active:scale-95 flex items-center gap-1.5 cursor-pointer"
                      >
                        Check In
                      </button>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 mb-6">
                  <div className="bg-white rounded-2xl p-3.5 border border-slate-200/80 shadow-xs flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-[10px] font-black text-text-muted uppercase tracking-wide">Next Milestone</span>
                      <p className="text-xs font-black text-text-primary m-0 truncate max-w-[180px]">
                  ...
                  <div className="bg-white rounded-2xl p-3.5 border border-slate-200/80 shadow-xs flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-cyan-500/10 text-cyan-600 flex items-center justify-center text-lg shrink-0">
                      <ShieldCheck className="w-5 h-5 text-cyan-600" />
                    </div>
                    <div>
                      <span className="text-[10px] font-black text-text-muted uppercase tracking-wide">Safety Checkpoints</span>
                      <p className="text-xs font-black text-text-primary m-0">
                  ...
                  <div className="bg-white rounded-2xl p-3.5 border border-slate-200/80 shadow-xs flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center text-lg shrink-0">
                      <Compass className="w-5 h-5 text-brand" />
                    </div>
                    <div>
                      <span className="text-[10px] font-black text-text-muted uppercase tracking-wide">Journey Activity</span>
                      <p className="text-xs font-black text-text-primary m-0">
            ...
            {activeTab === "Completed" && journeys.length > 3 && (
              <div className="flex justify-center pt-2">
                <button
                  ...
                  className="px-6 py-3 bg-white border border-slate-200 text-text-primary hover/80 font-bold text-xs uppercase tracking-wider rounded-2xl shadow-xs transition-all active:scale-95 flex items-center gap-2 cursor-pointer"
                >
