...
const NotificationsSettings = () => {
  ...
  if (!settings) return <div className="p-8 text-center text-slate-500">Loading...</div>;
    ...
    <div className="w-full max-w-7xl mx-auto pb-20">
      <div className="max-w-2xl mx-auto p-4 md:p-8 space-y-6">
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-500 font-medium mt-1">Manage how and when you are notified</p>
        </div>
